...
echo "${F_BOLD}${C_TURQUOISE2}${C_GREY0}IceCraft INSTALLER${NO_FORMAT}"
...
write_run_script() {
    ...
    echo "$TARGET_PATH/run/prep/packages/icecraft/unitary/IceCraft \$@" | tee -a "$1"
...
NO_FORMAT="\033[0m"
F_BOLD="\033[1m"
C_LIGHTGREEN="\033[38;5;120m"
C_GREY0="\033[48;5;16m"
echo "${F_BOLD}${C_LIGHTGREEN}${C_GREY0}CONGRATULATIONS!${NO_FORMAT}"
echo ""
